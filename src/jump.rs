...
impl Solution {
    ...
    /// are initially positioned at `nums[0]`. Each element `nums[i]`
    /// represents the maximum length of a forward jump from index `i`. In other
    ...
    /// ------
    ///
    /// ***Extracted from:*** [jump-game-ii](https://leetcode.com/problems/jump-game-ii/)
