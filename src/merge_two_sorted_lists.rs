...
mod tests {
    ...
    fn example1() {
        ...
        let list1 = Some(Box::new(ListNode {val: 2, next: list1}));
        let list1 = Some(Box::new(ListNode {val: 1, next: list1}));

        let list2 = Some(Box::new(ListNode::new(4)));
        let list2 = Some(Box::new(ListNode {val: 3, next: list2}));
        let list2 = Some(Box::new(ListNode {val: 1, next: list2}));

        let list3 = Some(Box::new(ListNode::new(4)));
        let list3 = Some(Box::new(ListNode {val: 4, next: list3}));
        let list3 = Some(Box::new(ListNode {val: 3, next: list3}));
        let list3 = Some(Box::new(ListNode {val: 2, next: list3}));
        let list3 = Some(Box::new(ListNode {val: 1, next: list3}));
        let list3 = Some(Box::new(ListNode {val: 1, next: list3}));
